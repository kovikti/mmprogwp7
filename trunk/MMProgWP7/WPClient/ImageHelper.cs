...
namespace WPClient
{
    public class ImageHelper
    {
        ...
        public static int GetAngleFromJpegImage(WriteableBitmap wbit)
        {
            //TODO
            return 90;
        }
        ...
        public static MemoryStream BitmapToMS (WriteableBitmap wBit, double longSide, int quality)
        {

            double wSource = wBit.PixelWidth;
            double hSource = wBit.PixelHeight;
            ...
            MemoryStream ms=new MemoryStream();
            wBit.SaveJpeg(ms, (int)wDest, (int)hDest, 0, quality);

            return ms;
        }

        //ND : I wrote this method to resample the image with the data stored in App class
        public static MemoryStream ResampleRotateBitmap(WriteableBitmap wBit, int angle, double longSide, int quality)
        {
        ...
        public static WriteableBitmap ResampleRotateBitmapToBitmap(WriteableBitmap wBit, int angle, double longSide, int quality)
        {
